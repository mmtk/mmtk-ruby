...
use mmtk::{memory_manager, Mutator, MutatorContext, TransitiveClosure};
...
pub unsafe extern "C" fn call_process_edge<T: TransitiveClosure>(
    closure: &mut T,
...
impl Scanning<Ruby> for VMScanning {
    ...
    fn scan_objects<W: ProcessEdgesWork<VM = Ruby>>(
